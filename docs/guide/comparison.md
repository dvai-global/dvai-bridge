...
- **Engines.** QVAC ships Fabric LLM, customized GGML, Whisper, Diffusion, ONNX, Bergamot. DVAI-Bridge ships llama.cpp, Apple Foundation Models, MLX, CoreML, MediaPipe LLM, LiteRT, LiteRT-LM (cross-platform, v4.2.0+) — including engines QVAC doesn't reach.
