...
# `Westenets/homebrew-dvai-hub` receives an automated PR from the
...
class DvaiHub < Formula
  ...
  homepage "https://github.com/Westenets/dvai-bridge"
  version "3.1.0"
  license "Custom — see LICENSE"

  if Hardware::CPU.arm?
    url "https://github.com/Westenets/dvai-bridge/releases/download/v#{version}/DVAI-Hub_#{version}_aarch64.dmg"
    sha256 "REPLACED_BY_RELEASE_WORKFLOW_AARCH64"
  else
    url "https://github.com/Westenets/dvai-bridge/releases/download/v#{version}/DVAI-Hub_#{version}_x64.dmg"
