...
#   - Mac only: also builds net10.0-ios26.2 and net10.0-maccatalyst26.2.
#
...
if [[ "$IS_MAC" == "1" ]]; then
  echo "==> dotnet build -f net10.0-ios26.2 (Mac host detected)"
  dotnet build -f net10.0-ios26.2 -c Release --nologo
  echo "==> dotnet build -f net10.0-maccatalyst26.2 (Mac host detected)"
  dotnet build -f net10.0-maccatalyst26.2 -c Release --nologo
else
