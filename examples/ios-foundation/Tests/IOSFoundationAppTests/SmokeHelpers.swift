// examples/ios-foundation/Tests/IOSFoundationAppTests/SmokeHelpers.swift
//
// Shared smoke-test helpers — duplicated per-example for SwiftPM
// ergonomics (see ios-llama/Tests/.../SmokeHelpers.swift for the rationale).
