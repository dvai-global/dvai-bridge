// Phase 2 Task 3 — `android-litert` example app.
// Minimal Compose UI driving DVAIBridge.start() with BackendKind.LiteRT.
...
android {
    namespace = "co.deepvoiceai.example.litert"
    compileSdk = (project.findProperty("compileSdkOverride") as String?)?.toInt() ?: 35

    defaultConfig {
        applicationId = "co.deepvoiceai.example.litert"
        minSdk = 24
